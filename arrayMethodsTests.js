...
const shuffle = constmyExports.shuffle;
...
describe("copySorted", function() {
    it("returns the sorted array", function() {
        let arr = [2, 3, 8, 1];
        assert.deepEqual(copySorted(arr), [1, 2, 3, 8]);
    });

    it(" test negative , returns the sorted array", function() {
        let arr = [-5, 3, 8, -11];
        assert.deepEqual(copySorted(arr)[-11, -5, 3, 8]);
    });
});

describe("sortByAge", function() {
    it("returns the sortByAge", function() {
